...
def main(args):
    ...
    # current_path = os.path.abspath(os.path.dirname(__file__))
    GIBBSCLUSTER = current_path + '/gibbscluster-2.0/gibbscluster'
    # GIBBSCLUSTER = '/public/home/hxu6/projects/HLA_Prediction/github_test/ImmuneApp/gibbscluster_2/gibbscluster'
...
if __name__ == '__main__':
    ...
    current_path = os.path.abspath(os.path.dirname(__file__))
    tmp_folder = current_path + "/" + args.output + "/"
    main(args)
